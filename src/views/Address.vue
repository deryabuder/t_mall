        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  <li v-for="(item, index) in addressListFilter" :key="item.addressId" :class="{'check': index===checkIndex}" @click="checkIndex=index;selectedAddrId=item.addressId">
                    <dl>
                      <dt>{{item.userName}}</dt>
...
import {addressList, setDefault, delAddress} from '../api/apiInterface'
export default {
  data () {
    return {
      // 控制显示地址的数目
